...
class IndexService:
    ...
    def __call__(self):
        ...
        try:
            ...
            raise SemanticImageSearchException("Error initializing IndexService", e)
    ...
    def index_image(self, image_path: str, category: Optional[str]=None):
        ...
        try:
            ...
            raise SemanticImageSearchException("Error indexing single image", e)
    ...
    def index_folder(self, root_folder: str | os.PathLike):
        ...
        log.info("Start folder Indexing", folder=root_folder)
        ...
        for dirpath, _, files in os.walk(root_folder):
            ...
            try:
                ...
                points = [
                    ...
                    for vector, paylpoad in zip(vectors, payloads) 
                ]
                ...
                log.info("Folder indexed successfully",
                         folder=dirpath, total_images=len(points))
                
            except Exception as e:
                log.error("Failed to index folder", folder=dirpath, error=str(e))
                raise SemanticImageSearchException("Error indexing folder", e)
